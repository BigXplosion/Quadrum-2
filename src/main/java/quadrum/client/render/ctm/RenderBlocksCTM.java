...
public class RenderBlocksCTM extends RenderBlocks {
	...
	public void renderFaceXNeg(Block block, double x, double y, double z, IIcon icon) {
		...
		ConnectedTexture texture = ConnectedTextureHandler.getConnectedTexture(block, meta, 4);
		if (texture == null)
	...
	public void renderFaceXPos(Block block, double x, double y, double z, IIcon icon) {
		int meta = blockAccess.getBlockMetadata(bx, by, bz);
		ConnectedTexture texture = ConnectedTextureHandler.getConnectedTexture(block, meta, 5);
		if (texture == null)
	...
	public void renderFaceZNeg(Block block, double x, double y, double z, IIcon icon) {
		int meta = blockAccess.getBlockMetadata(bx, by, bz);
		ConnectedTexture texture = ConnectedTextureHandler.getConnectedTexture(block, meta, 2);
		if (texture == null)
	...
	public void renderFaceZPos(Block block, double x, double y, double z, IIcon icon) {
		int meta = blockAccess.getBlockMetadata(bx, by, bz);
		ConnectedTexture texture = ConnectedTextureHandler.getConnectedTexture(block, meta, 3);
		if (texture == null)
	...
	public void renderFaceYNeg(Block block, double x, double y, double z, IIcon icon) {
		int meta = blockAccess.getBlockMetadata(bx, by, bz);
		ConnectedTexture texture = ConnectedTextureHandler.getConnectedTexture(block, meta, 0);
		if (texture == null)
	...
	public void renderFaceYPos(Block block, double x, double y, double z, IIcon icon) {
		int meta = blockAccess.getBlockMetadata(bx, by, bz);
		ConnectedTexture texture = ConnectedTextureHandler.getConnectedTexture(block, meta, 1);
		if (texture == null)
